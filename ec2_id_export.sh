...
export Public_12_101=$(aws ec2 describe-instances --filters 'Name=tag:Name,Values=ICNVPC-Public-10.11.11.103' 'Name=instance-state-name,Values=running' | jq -r '.Reservations[].Instances[].InstanceId')
export Public_12_102=$(aws ec2 describe-instances --filters 'Name=tag:Name,Values=ICNVPC-Public-10.11.12.104' 'Name=instance-state-name,Values=running' | jq -r '.Reservations[].Instances[].InstanceId')
export Public_11_101=$(aws ec2 describe-instances --filters 'Name=tag:Name,Values=ICNVPC-Public-10.11.12.101' 'Name=instance-state-name,Values=running' | jq -r '.Reservations[].Instances[].InstanceId')
export Public_11_102=$(aws ec2 describe-instances --filters 'Name=tag:Name,Values=ICNVPC-Public-10.11.12.102' 'Name=instance-state-name,Values=running' | jq -r '.Reservations[].Instances[].InstanceId')
export Public_12_101=$(aws ec2 describe-instances --filters 'Name=tag:Name,Values=ICNVPC-Public-10.11.12.103' 'Name=instance-state-name,Values=running' | jq -r '.Reservations[].Instances[].InstanceId')
export Public_12_102=$(aws ec2 describe-instances --filters 'Name=tag:Name,Values=ICNVPC-Public-10.11.12.104' 'Name=instance-state-name,Values=running' | jq -r '.Reservations[].Instances[].InstanceId')
...
export Prviate_22_101=$(aws ec2 describe-instances --filters 'Name=tag:Name,Values=ICNVPC-Private-10.11.21.103' 'Name=instance-state-name,Values=running' | jq -r '.Reservations[].Instances[].InstanceId')
export Prviate_22_102=$(aws ec2 describe-instances --filters 'Name=tag:Name,Values=ICNVPC-Private-10.11.22.104' 'Name=instance-state-name,Values=running' | jq -r '.Reservations[].Instances[].InstanceId')
export Prviate_21_101=$(aws ec2 describe-instances --filters 'Name=tag:Name,Values=ICNVPC-Private-10.11.22.101' 'Name=instance-state-name,Values=running' | jq -r '.Reservations[].Instances[].InstanceId')
export Prviate_21_102=$(aws ec2 describe-instances --filters 'Name=tag:Name,Values=ICNVPC-Private-10.11.22.102' 'Name=instance-state-name,Values=running' | jq -r '.Reservations[].Instances[].InstanceId')
export Prviate_22_101=$(aws ec2 describe-instances --filters 'Name=tag:Name,Values=ICNVPC-Private-10.11.22.103' 'Name=instance-state-name,Values=running' | jq -r '.Reservations[].Instances[].InstanceId')
export Prviate_22_102=$(aws ec2 describe-instances --filters 'Name=tag:Name,Values=ICNVPC-Private-10.11.22.104' 'Name=instance-state-name,Values=running' | jq -r '.Reservations[].Instances[].InstanceId')
...
echo "export Private_11_101=${Public_11_101}"| tee -a ~/.bash_profile
echo "export Private_11_102=${Public_11_102}"| tee -a ~/.bash_profile
echo "export Private_11_103=${Public_11_103}"| tee -a ~/.bash_profile
echo "export Private_11_104=${Public_11_104}"| tee -a ~/.bash_profile
echo "export Private_12_101=${Public_12_101}"| tee -a ~/.bash_profile
echo "export Private_12_102=${Public_12_102}"| tee -a ~/.bash_profile
echo "export Private_12_103=${Public_12_103}"| tee -a ~/.bash_profile
echo "export Private_12_104=${Public_12_104}"| tee -a ~/.bash_profile
source ~/.bash_profile
