...
export Private_21_101=$(aws ec2 describe-instances --filters 'Name=tag:Name,Values=ICNVPC-Private-10.11.21.101' 'Name=instance-state-name,Values=running' | jq -r '.Reservations[].Instances[].InstanceId')
export Private_21_102=$(aws ec2 describe-instances --filters 'Name=tag:Name,Values=ICNVPC-Private-10.11.21.102' 'Name=instance-state-name,Values=running' | jq -r '.Reservations[].Instances[].InstanceId')
export Private_21_103=$(aws ec2 describe-instances --filters 'Name=tag:Name,Values=ICNVPC-Private-10.11.21.103' 'Name=instance-state-name,Values=running' | jq -r '.Reservations[].Instances[].InstanceId')
export Private_21_104=$(aws ec2 describe-instances --filters 'Name=tag:Name,Values=ICNVPC-Private-10.11.21.104' 'Name=instance-state-name,Values=running' | jq -r '.Reservations[].Instances[].InstanceId')
export Private_22_101=$(aws ec2 describe-instances --filters 'Name=tag:Name,Values=ICNVPC-Private-10.11.22.101' 'Name=instance-state-name,Values=running' | jq -r '.Reservations[].Instances[].InstanceId')
export Private_22_102=$(aws ec2 describe-instances --filters 'Name=tag:Name,Values=ICNVPC-Private-10.11.22.102' 'Name=instance-state-name,Values=running' | jq -r '.Reservations[].Instances[].InstanceId')
export Private_22_103=$(aws ec2 describe-instances --filters 'Name=tag:Name,Values=ICNVPC-Private-10.11.22.103' 'Name=instance-state-name,Values=running' | jq -r '.Reservations[].Instances[].InstanceId')
export Private_22_104=$(aws ec2 describe-instances --filters 'Name=tag:Name,Values=ICNVPC-Private-10.11.22.104' 'Name=instance-state-name,Values=running' | jq -r '.Reservations[].Instances[].InstanceId')
