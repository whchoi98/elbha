...
export Public_11_101=$(aws ec2 describe-instances --filters 'Name=tag:Name,Values=ICNVPC-Public-10.11.11.103' 'Name=instance-state-name,Values=running' | jq -r '.Reservations[].Instances[].InstanceId')
export Public_11_102=$(aws ec2 describe-instances --filters 'Name=tag:Name,Values=ICNVPC-Public-10.11.12.104' 'Name=instance-state-name,Values=running' | jq -r '.Reservations[].Instances[].InstanceId')
...
export Prviate_21_104=$(aws ec2 describe-instances --filters 'Name=tag:Name,Values=ICNVPC-Private-10.11.22.104' 'Name=instance-state-name,Values=running' | jq -r '.Reservations[].Instances[].InstanceId')
